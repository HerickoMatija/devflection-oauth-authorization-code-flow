...
export const TOKEN_ENDPOINT_URL = "http://localhost:8083/auth/realms/master/protocol/openid-connect/token";
export const CLIENT_ID = "devflection-node-js";
export const CLIENT_SECRET = "u2Y5vqEykBctmFhXnxzn0fp3s8H9rYXv";